...
class BuilderTest extends \PHPUnit_Framework_TestCase
{
     ...
     * @test
     *
     * @covers \Lcobucci\JWT\Storage\Builder::__construct
     */
     ...
     * @uses \Lcobucci\JWT\Storage\Builder::with
     *
     * @covers \Lcobucci\JWT\Storage\Builder::expiresAt
     * @covers \Lcobucci\JWT\Storage\Builder::setRegisteredClaim
     */
     ...
     * @uses \Lcobucci\JWT\Storage\Builder::with
     *
     * @covers \Lcobucci\JWT\Storage\Builder::identifiedBy
     * @covers \Lcobucci\JWT\Storage\Builder::setRegisteredClaim
     */
     ...
     * @uses \Lcobucci\JWT\Storage\Builder::with
     *
     * @covers \Lcobucci\JWT\Storage\Builder::issuedAt
     * @covers \Lcobucci\JWT\Storage\Builder::setRegisteredClaim
     */
     ...
     * @uses \Lcobucci\JWT\Storage\Builder::with
     *
     * @covers \Lcobucci\JWT\Storage\Builder::issuedBy
     * @covers \Lcobucci\JWT\Storage\Builder::setRegisteredClaim
     */
     ...
     * @uses \Lcobucci\JWT\Storage\Builder::with
     *
     * @covers \Lcobucci\JWT\Storage\Builder::canOnlyBeUsedAfter
     * @covers \Lcobucci\JWT\Storage\Builder::setRegisteredClaim
     */
     ...
     * @uses \Lcobucci\JWT\Storage\Builder::with
     *
     * @covers \Lcobucci\JWT\Storage\Builder::relatedTo
     * @covers \Lcobucci\JWT\Storage\Builder::setRegisteredClaim
     */
     ...
     * @uses \Lcobucci\JWT\Storage\Builder::__construct
     *
     * @covers \Lcobucci\JWT\Storage\Builder::with
     */
     ...
     * @uses \Lcobucci\JWT\Storage\Builder::__construct
     *
     * @covers \Lcobucci\JWT\Storage\Builder::withHeader
     */
     ...
     *
     * @uses \Lcobucci\JWT\Storage\Builder::__construct
     * @uses \Lcobucci\JWT\Storage\Builder::getToken
     * @uses \Lcobucci\JWT\Storage\Builder::encodeClaims
     * @uses \Lcobucci\JWT\Storage\Builder::encodeHeaders
     * @uses \Lcobucci\JWT\Signer\Key
     * @uses \Lcobucci\JWT\Storage\Token
     * @uses \Lcobucci\JWT\Storage\DataSet
     *
     * @covers \Lcobucci\JWT\Storage\Builder::sign
     */
     ...
     *
     * @covers \Lcobucci\JWT\Storage\Builder::unsign
     */
     ...
     *
     * @uses \Lcobucci\JWT\Storage\Builder::__construct
     * @uses \Lcobucci\JWT\Storage\Builder::sign
     * @uses \Lcobucci\JWT\Storage\Builder::getToken
     * @uses \Lcobucci\JWT\Storage\Builder::encodeClaims
     * @uses \Lcobucci\JWT\Storage\Builder::encodeHeaders
     * @uses \Lcobucci\JWT\Signer\Key
     ...
     * @uses \Lcobucci\JWT\Storage\DataSet
     *
     * @covers \Lcobucci\JWT\Storage\Builder::getToken
     * @covers \Lcobucci\JWT\Storage\Builder::encodeClaims
     * @covers \Lcobucci\JWT\Storage\Builder::encodeHeaders
     */
